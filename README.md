...
🎒 **中学生向け超詳細ガイド**: [本ページ下部](#-中学生でもできる超詳細セットアップガイド) または [docs/SETUP_GUIDE.md](./docs/SETUP_GUIDE.md)
...
> **⚡ 初心者の方へ**  
> 下の「[🎒 中学生でもできる超詳細セットアップガイド](#-中学生でもできる超詳細セットアップガイド)」をご覧ください。プログラミング経験ゼロでも、書いてある通りに順番にやれば完成します。**経験者の方はこの節だけで十分です。**
...
11. [中学生向けトラブルシューティング](#中学生向けトラブルシューティング)
12. [用語集](#用語集)
...
| `docs/SETUP_GUIDE.md` | 中学生向け超詳細セットアップガイド (完全版) |
...
- ハードウェア一覧 (総額1万円前後)
- **🎒 中学生でもできる超詳細ガイド (8ステップ、アコーディオン展開式)**
- よくあるトラブルシューティング
- CTA + フッター
